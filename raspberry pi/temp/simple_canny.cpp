...
int main()
{
   ...
   std::string pipeline2 = gstreamer_pipeline2(capture_width,
	...
	cv::hconcat(img,img2,img);//img+img2 = img horizen
	//cv::Canny(img2,img4,100,200);//img4=img2.canny
	cv::Canny(img,img3,100,200);//img3=img.canny = (img+img2).canny
	//cv::vconcat(img,img3,img4);//img+img3 = img virtical
	cv::imshow("CSI Camera",img);
	//cv::imshow("CSI Camera2",img2);
	cv::imshow("canny",img3);
	//cv::imshow("canny-2",img4);
