/********************************************************************************
** Form generated from reading UI file 'tab1_stream.ui'
**
...
#ifndef UI_TAB1_STREAM_H
#define UI_TAB1_STREAM_H
...
public:
    ...
    void setupUi(QWidget *tab1opencv_stream_test)
    {
        ...
        pL_Cam = new QVBoxLayout();
        pL_Cam->setObjectName(QString::fromUtf8("pL_Cam"));

        horizontalLayout_4->addLayout(pL_Cam);
