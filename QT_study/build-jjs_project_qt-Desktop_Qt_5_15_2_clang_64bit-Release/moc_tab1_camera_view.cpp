...
#include <memory>
#include "../../QT_SRC/jjs_project_qt/tab1_camera_view.h"
...
QT_MOC_LITERAL(7, 63, 10), // "getRespone"
QT_MOC_LITERAL(8, 74, 5) // "getIp"

    },
    "Tab1_Camera_view\0sigsend_tab1\0\0url_load\0"
    "url_pause\0capture\0move\0getRespone\0"
    "getIp"
};
...
void Tab1_Camera_view::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->getRespone((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 6: _t->getIp((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
